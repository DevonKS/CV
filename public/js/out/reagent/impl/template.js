...
var G__26738 = o;
(G__26738[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__26740__i < G__26740__a.length) {G__26740__a[G__26740__i] = arguments[G__26740__i + 0]; ++G__26740__i;}
  args = new cljs.core.IndexedSeq(G__26740__a,0);
} 
...
var G__26747 = jsprops;
(G__26747["defaultValue"] = value);

(G__26747["onChange"] = ((function (G__26747,v,value,on_change){
return (function (p1__26744_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26744_SHARP_);
});})(G__26747,v,value,on_change))
);

(G__26747["ref"] = ((function (G__26747,v,value,on_change){
return (function (p1__26745_SHARP_){
return (this$["cljsInputElement"] = p1__26745_SHARP_);
});})(G__26747,v,value,on_change))
);
...
var vec__26754 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26754,(0),null);
var id = cljs.core.nth.call(null,vec__26754,(1),null);
var class$ = cljs.core.nth.call(null,vec__26754,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26759 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26759 == null)){
} else {
var key_26760 = temp__4661__auto___26759;
(jsprops["key"] = key_26760);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26762 = (new reagent.impl.template.NativeWrapper());
(G__26762["name"] = c);
...
var len__21234__auto___26768 = arguments.length;
var i__21235__auto___26769 = (0);
while(true){
if((i__21235__auto___26769 < len__21234__auto___26768)){
args__21241__auto__.push((arguments[i__21235__auto___26769]));

var G__26770 = (i__21235__auto___26769 + (1));
i__21235__auto___26769 = G__26770;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26766){
var G__26767 = cljs.core.first.call(null,seq26766);
var seq26766__$1 = cljs.core.next.call(null,seq26766);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26767,seq26766__$1);
});
...
break;
default:
var G__26774 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26774;
continue;
...
var n__21074__auto___26777 = a.length;
var i_26778 = (0);
while(true){
if((i_26778 < n__21074__auto___26777)){
(a[i_26778] = reagent.impl.template.as_element.call(null,(a[i_26778])));

var G__26779 = (i_26778 + (1));
i_26778 = G__26779;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21074__auto___26780 = a.length;
var i_26781 = (0);
while(true){
if((i_26781 < n__21074__auto___26780)){
var val_26782 = (a[i_26781]);
if((cljs.core.vector_QMARK_.call(null,val_26782)) && ((reagent.impl.template.key_from_vec.call(null,val_26782) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26781] = reagent.impl.template.as_element.call(null,val_26782));
...
var ctx = ({});
var vec__26787 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26787,(0),null);
var derefed = cljs.core.nth.call(null,vec__26787,(1),null);
...
var G__26791 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26791) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26791){
